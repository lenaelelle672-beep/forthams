...
# 前端静态文件（backend 配置了 spring.web.resources.static-locations=file:/app/static/）
...
ENTRYPOINT ["tini", "--", "java", "-jar", "/app/app.jar", "--spring.web.resources.static-locations=file:/app/static/"]
