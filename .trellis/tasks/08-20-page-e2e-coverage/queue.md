...
| Q3699 | pending | 桌面空态：外部系统真实调用路径余项。禁 /m。 |
| Q3700 | pending | 桌面空态：外部系统目录掩码余项。禁 /m。 |
| Q3701 | pending | 桌面空态：外部系统只展示目录余项。禁 /m。 |
| Q3702 | pending | 桌面空态：外部系统校验结果余项。禁 /m。 |
| Q3703 | pending | 桌面空态：外部系统目录状态余项。禁 /m。 |
| Q3704 | pending | 桌面空态：外部系统 config-only 余项。禁 /m。 |
| Q3705 | pending | 桌面空态：外部系统路径与掩码余项。禁 /m。 |
| Q3706 | pending | 桌面空态：流程设计器处理人预览未用角色。禁 /m。 |
| Q3707 | pending | 桌面空态：下一票继续真页未用角色。禁 /m。 |
