...
| Q3667 | pending | 桌面空态：租户管理只读边界余项。禁 /m。 |
| Q3668 | pending | 桌面空态：租户管理写操作边界余项。禁 /m。 |
| Q3669 | pending | 桌面空态：数据权限范围说明余项。禁 /m。 |
| Q3670 | pending | 桌面空态：数据权限写入边界余项。禁 /m。 |
| Q3671 | pending | 桌面空态：租户接口路径余项。禁 /m。 |
| Q3672 | pending | 桌面空态：数据权限 CUSTOM 余项。禁 /m。 |
| Q3673 | pending | 桌面空态：租户主数据边界余项。禁 /m。 |
| Q3674 | pending | 桌面空态：数据权限编辑权限余项。禁 /m。 |
| Q3675 | pending | 桌面空态：下一票继续真页未用角色。禁 /m。 |
