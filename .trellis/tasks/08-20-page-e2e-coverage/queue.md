...
| Q3715 | pending | 桌面空态：审批规则短数组与禁止 JS 余项。禁 /m。 |
| Q3716 | pending | 桌面空态：审批规则反射与 OGNL 余项。禁 /m。 |
| Q3717 | pending | 桌面空态：审批规则 parser 白名单余项。禁 /m。 |
| Q3718 | pending | 桌面空态：审批规则 JS/OGNL 组合余项。禁 /m。 |
| Q3719 | pending | 桌面空态：审批规则字段比较组合余项。禁 /m。 |
| Q3720 | pending | 桌面空态：审批规则反射类加载余项。禁 /m。 |
| Q3721 | pending | 桌面空态：审批规则脚本引擎组合余项。禁 /m。 |
| Q3722 | pending | 桌面空态：审批规则接口路径整句余项。禁 /m。 |
| Q3723 | pending | 桌面空态：下一票继续真页未用角色。禁 /m。 |
