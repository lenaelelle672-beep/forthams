...
| Q3187 | in_progress | 桌面空态：部门组织空表（部门组织/部门列表/暂无部门组织数据。）。禁 /m。 |
| Q3188 | pending | 桌面空态：部门组织根部门（暂无根部门/根部门摘要/搜索占位）。禁 /m。 |
| Q3189 | pending | 桌面空态：部门组织检索（部门关键词/搜索/重新加载）。禁 /m。 |
| Q3190 | pending | 桌面空态：通知渠道空表（通知渠道/渠道 catalog/暂无通知渠道）。禁 /m。 |
| Q3191 | pending | 桌面空态：通知渠道详情（渠道详情/通知渠道配置/读取详情）。禁 /m。 |
| Q3192 | pending | 桌面空态：通知渠道预览（配置名称/样例相对路径/无持久化预览）。禁 /m。 |
