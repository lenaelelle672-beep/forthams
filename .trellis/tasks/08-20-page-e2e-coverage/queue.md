...
| Q3373 | in_progress | 桌面空态：交接管理分页（上一页/下一页/第 n 页）。禁 /m。 |
| Q3374 | pending | 桌面空态：交接管理其余（已完成/显示 0 条/真实资产）。禁 /m。 |
| Q3375 | pending | 桌面空态：文档中心分页（上一页/下一页/文档分类）。禁 /m。 |
| Q3376 | pending | 桌面空态：文档中心其余（已发布/版本/更新时间）。禁 /m。 |
| Q3377 | pending | 桌面空态：技术支持分页（上一页/下一页/重新加载）。禁 /m。 |
| Q3378 | pending | 桌面空态：技术支持筛选项（已解决/已关闭/普通）。禁 /m。 |
| Q3379 | pending | 桌面空态：技术支持其余（搜索/时间列/只读提示）。禁 /m。 |
