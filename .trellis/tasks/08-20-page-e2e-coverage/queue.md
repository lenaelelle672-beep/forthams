...
| Q3739 | pending | 桌面空态：字段映射预览边界余项。禁 /m。 |
| Q3740 | pending | 桌面空态：字段映射转换表达式余项。禁 /m。 |
| Q3741 | pending | 桌面空态：字段映射整句说明余项。禁 /m。 |
| Q3742 | pending | 桌面空态：接口管理元数据校验余项。禁 /m。 |
| Q3743 | pending | 桌面空态：接口管理只加载余项。禁 /m。 |
| Q3744 | pending | 桌面空态：菜单权限编码库存余项。禁 /m。 |
| Q3745 | pending | 桌面空态：菜单权限只读目录余项。禁 /m。 |
| Q3746 | pending | 桌面空态：菜单权限覆盖视图余项。禁 /m。 |
| Q3747 | pending | 桌面空态：下一票继续真页未用角色。禁 /m。 |
