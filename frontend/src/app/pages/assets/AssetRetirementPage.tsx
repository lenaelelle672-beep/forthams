...
export const AssetRetirementPage: React.FC = () => {
   ...
   *
   * Validates form fields, calls the submit hook, and navigates to the
  ...
  const handleSubmit = useCallback(
    ...
    [assetId, reason, expectedDate, submitRetirement, navigate]
  );
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-12" data-testid="retirement-page">
      ...
      {/* Error toast for cross-tenant / submission errors */}
      {submitError && (
        <div
