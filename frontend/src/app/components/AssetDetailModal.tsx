      ...
      <div className="bg-white rounded-lg w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between sticky top-0 bg-white z-10">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">资产编号: {asset.id}</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <div className="overflow-hidden rounded-sm">
              <table className="w-full border-collapse border border-gray-200 text-sm text-left">
                <tbody>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">资产编号: </span> 
                      <span className="text-gray-900 ml-1">{asset.id}</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">资产名称: </span> 
                      <span className="text-gray-900 ml-1">{asset.name}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">使用保管人: </span> 
                      <span className="text-gray-900 ml-1">{asset.user}</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">使用人工号: </span> 
                      <span className="text-gray-900 ml-1">03361</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">使用部门: </span> 
                      <span className="text-gray-900 ml-1">{asset.department}</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">部门编码: </span> 
                      <span className="text-gray-900 ml-1">D0010</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">首次领用日期: </span> 
                      <span className="text-gray-900 ml-1">{asset.purchaseDate || "2024/01/22"}</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">附属物品: </span> 
                      <span className="text-gray-900 ml-1">电源适配器</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">外贸合同号: </span> 
                      <span className="text-gray-900 ml-1">-</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">监管期限: </span> 
                      <span className="text-gray-900 ml-1">-</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">关联公司: </span> 
                      <span className="text-gray-900 ml-1">UNIVIEW</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">PO号: </span> 
                      <span className="text-gray-900 ml-1">PO20240101</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">帐套: </span> 
                      <span className="text-gray-900 ml-1">深圳总账</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">最新转移时间: </span> 
                      <span className="text-gray-900 ml-1">2024/01/22</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">资产序列号: </span> 
                      <span className="text-gray-900 ml-1">7J1L33</span>
                    </td>
                    <td className="border border-gray-200 px-4 py-3 w-1/2 bg-white">
                      <span className="text-gray-500 font-medium">区域: </span> 
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-gray-500">最后更新: 2024-03-08 14:30</span>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex gap-4 pb-3 border-b border-gray-200 last:border-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">从研发部转移至设计部 | 操作人: 张三</p>
                </div>
              </div>
              <div className="flex gap-4 pb-3 border-b border-gray-200 last:border-0">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-400">{asset.purchaseDate}</span>
                  </div>
                  <p className="text-sm text-gray-500 mt-1">资产采购入库 | 操作人: 李四</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">1.8 MB</p>
                  </div>
                </div>
                <button className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                  下载
