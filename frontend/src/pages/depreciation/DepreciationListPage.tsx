...
export default function DepreciationListPage() {
  ...
  const columns: Column<DepreciationScheduleItem>[] = useMemo(() => [
    ...
    },
    {
      ...
      width: 130,
      render: (v, row) => (
        <a className="font-mono text-xs font-semibold text-blue-600 hover:text-blue-700 hover:underline cursor-pointer"
    ...
    },
    {
      ...
      render: (_v, row) => (
        <div className="min-w-[160px]">
          <a className="text-sm font-semibold text-slate-900 hover:text-blue-600 hover:underline cursor-pointer"
             onClick={() => navigate(`/assets/${row.assetId}`)}>
            {row.assetName}
          </a>
