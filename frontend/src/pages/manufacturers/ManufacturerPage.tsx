...
import {
  Plus, Search, Pencil, Trash2, Factory, CheckCircle, XCircle, Globe,
} from 'lucide-react';
...
export default function ManufacturerPage() {
  ...
  const websiteCount = useMemo(() => records.filter((r) => r.website && r.website.trim()).length, [records]);
      ...
      <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-6">
        ...
        <section className="rounded-2xl border border-[var(--surface-border)] bg-white shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-slate-100 border-t border-slate-100">
            ...
            <div className="flex items-center gap-3 px-6 py-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-400 shadow-sm">
            ...
            <div className="flex items-center gap-3 px-6 py-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-purple-400 shadow-sm">
            ...
            <div className="flex items-center gap-3 px-6 py-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-rose-400 shadow-sm">
          ...
          <div className="flex flex-col gap-3 border-b border-slate-100 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`${filterPillBase} ${statusFilter === undefined ? filterPillActive : filterPillInactive}`}
              >
                全部
              </button>
              <button
                onClick={() => { setStatusFilter(statusFilter === 0 ? undefined : 0); setPage(1); }}
                className={`${filterPillBase} ${statusFilter === 0 ? filterPillActive : filterPillInactive}`}
              >
                正常
              </button>
              <button
                onClick={() => { setStatusFilter(statusFilter === 1 ? undefined : 1); setPage(1); }}
                className={`${filterPillBase} ${statusFilter === 1 ? filterPillActive : filterPillInactive}`}
              >
                停用
              </button>
            </div>
