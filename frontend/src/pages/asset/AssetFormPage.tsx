...
const schema = z.object({
  ...
  locationLat:     z.coerce.number().min(-90, '纬度范围 -90 ~ 90').max(90, '纬度范围 -90 ~ 90').optional(),
  locationLng:     z.coerce.number().min(-180, '经度范围 -180 ~ 180').max(180, '经度范围 -180 ~ 180').optional(),
...
const formSections: FormSection[] = [
  ...
  },
  {
    ...
    fields: ['deptId', 'location', 'locationLat', 'locationLng', 'rfidTag', 'isImportant'],
  },
  {
    id: 'finance',
    title: '财务信息',
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-medium text-gray-500">GIS 坐标（用于地图定位，选填）</span>
                </div>
