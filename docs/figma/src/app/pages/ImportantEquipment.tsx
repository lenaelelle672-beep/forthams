...
const maintenanceRecords = [
  { id: 1, equipment: 'CNC-05', date: '2024-02-15', type: '定期保养', technician: '李工', duration: '2小时', cost: '¥800', status: '已完成' },
  { id: 2, equipment: 'LC-08', date: '2024-02-20', type: '故障维修', technician: '王工', duration: '4小时', cost: '¥1,500', status: '已完成' },
  { id: 3, equipment: 'RB-12', date: '2024-01-10', type: '定期保养', technician: '张工', duration: '3小时', cost: '¥1,200', status: '已完成' },
  { id: 4, equipment: 'PM-06', date: '2024-02-25', type: '校准检测', technician: '赵工', duration: '1.5小时', cost: '¥600', status: '已完成' },
];

const alerts = [
  { id: 1, equipment: '工业机器人 RB-12', type: 'danger', message: '保养计划已逾期 2天', time: '2024-03-10' },
  { id: 2, equipment: '激光切割机 LC-08', type: 'warning', message: '保养计划将于3天后到期', time: '2024-03-20' },
  { id: 3, equipment: '数控机床 CNC-05', type: 'info', message: '使用率持续偏高,建议检查', time: '2024-03-08' },
];
            ...
            <tbody className="divide-y divide-gray-200">
              {maintenanceRecords.map((record) => (
                <tr key={record.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 text-sm font-medium text-gray-900">{record.equipment}</td>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="number" step="0.5" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="请详细描述保养内容..."></textarea>
              </div>
            </div>
