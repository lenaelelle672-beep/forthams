...
const approvals = [
  {
    id: 'APR-2024-001',
    type: '资产新增',
    title: '采购 10 台 ThinkPad X1 Carbon 笔记本',
    applicant: '张三',
    department: '研发部',
    amount: '¥85,000',
    submitDate: '2024-03-08 10:30',
    status: '待审批',
    currentApprover: '李经理',
    urgency: '普通',
    details: '研发部新员工入职,需采购笔记本电脑'
  },
  {
    id: 'APR-2024-002',
    type: '资产转移',
    title: '投影仪从会议室A调至会议室B',
    applicant: '李四',
    department: '行政部',
    amount: '-',
    submitDate: '2024-03-08 09:15',
    status: '审批中',
    currentApprover: '王经理',
    urgency: '普通',
    approvalHistory: [
      { approver: '张主管', result: '已通过', time: '2024-03-08 09:30', comment: '同意转移' }
    ]
  },
  {
    id: 'APR-2024-003',
    ...
    urgency: '普通',
    approvalHistory: [
      { approver: '张主管', result: '已通过', time: '2024-03-07 15:00', comment: '设备已达报废年限' },
      { approver: '李经理', result: '已通过', time: '2024-03-07 16:30', comment: '同意报废' }
    ],
    completeDate: '2024-03-07 16:30'
  },
  {
    id: 'APR-2024-004',
    type: '保养申请',
    title: '数控机床 CNC-05 月度保养',
    applicant: '赵六',
    department: '生产部',
    amount: '¥1,200',
    submitDate: '2024-03-08 08:00',
    status: '待审批',
    currentApprover: '孙经理',
    urgency: '紧急',
    details: '设备保养已到期,需尽快安排'
  },
  {
    id: 'APR-2024-005',
    type: '赔偿申请',
    title: 'iPhone 14 Pro 设备丢失赔偿',
    applicant: '孙七',
    department: '销售部',
    amount: '¥8,000',
    submitDate: '2024-03-07 11:45',
    status: '已驳回',
    urgency: '普通',
    approvalHistory: [
      { approver: '王经理', result: '已驳回', time: '2024-03-07 14:00', comment: '未提供充分证明材料' }
    ],
    completeDate: '2024-03-07 14:00'
  },
];
...
const workOrders = [
  ...
  },
  {
    id: 'WO-2024-002',
    type: '设备保养',
    equipment: '数控机床 CNC-05',
    reporter: '李四',
    status: '待派工',
    assignee: '-',
    priority: '中',
    createTime: '2024-03-08 09:30',
    description: '月度定期保养'
  },
  {
    id: 'WO-2024-003',
    type: '设备维修',
    equipment: '工业机器人 RB-12',
    reporter: '王五',
    status: '已完成',
    assignee: '张工',
    priority: '中',
    createTime: '2024-03-07 14:00',
    completeTime: '2024-03-07 18:30',
    description: '机械臂定位不准'
  },
];
