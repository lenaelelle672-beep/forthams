...
const mockData = [
  { id: 'DP-2024-001', assetName: 'ThinkPad X1 Carbon', type: '资产转移', applicant: '张三', date: '2024-03-10', status: '审批中' },
  { id: 'DP-2024-002', assetName: '办公桌椅套装', type: '资产清退', applicant: '李四', date: '2024-03-09', status: '已完成' },
  { id: 'DP-2024-003', assetName: '旧款打印机', type: '资产报废转让', applicant: '王五', date: '2024-03-08', status: '已驳回' },
  { id: 'DP-2024-004', assetName: 'iPhone 13', type: '资产赔偿', applicant: '赵六', date: '2024-03-05', status: '已完成' },
];
        ...
        <div className="overflow-x-auto border border-gray-200 rounded-lg">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {mockData.filter(d => tabs.find(t => t.id === activeTab)?.name === d.type || activeTab === 'all').map((item, idx) => (
              ...
              {mockData.filter(d => tabs.find(t => t.id === activeTab)?.name === d.type).length === 0 && (
                <tr>
