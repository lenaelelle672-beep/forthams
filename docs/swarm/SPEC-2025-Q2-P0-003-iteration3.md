...
| 文件路径 | 修改说明 |
|----------|----------|
| `frontend/tests/e2e/approval.spec.ts` | 更新 E2E 测试用例覆盖一键审批/驳回流程 |
| `frontend/src/types/approval.ts` | 添加 `WorkOrderApprovalDTO` 及审批相关类型定义 |
| `backend/api/v1/schemas/reject_request.py` | 更新驳回请求 schema |
| `src/api/v1/approval.py` | 添加审批 API 端点 |
| `src/api/v1/workorders.py` | 集成状态机调用 |
