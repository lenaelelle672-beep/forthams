...
class RolePermissionCatalogServiceTest {
    ...
    void getCatalogShouldAggregateRolesPermissionsAndValidBindings() {
        jdbcTemplate.update("INSERT INTO sys_role(id, role_name, role_code, description, status, deleted) VALUES (1, '超级管理员', 'SUPER_ADMIN', '全部权限', 1, 0)");
        jdbcTemplate.update("INSERT INTO sys_role(id, role_name, role_code, description, status, deleted) VALUES (2, '审计角色', 'AUDITOR', '只读审计', 1, 0)");
        jdbcTemplate.update("INSERT INTO sys_role(id, role_name, role_code, description, status, deleted) VALUES (3, '历史角色', 'LEGACY', '已删除', 0, 1)");
        ...
        jdbcTemplate.update("INSERT INTO sys_role_permission(role_id, permission_id) VALUES (1, 10), (1, 11), (2, 11), (2, 12), (99, 11)");
    ...
    void getCatalogShouldCountUnboundInventoryAndRolesWithoutPermissions() {
        jdbcTemplate.update("INSERT INTO sys_role(id, role_name, role_code, description, status, deleted) VALUES (1, '普通用户', 'USER', '默认角色', 1, 0)");
