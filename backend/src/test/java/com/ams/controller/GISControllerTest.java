...
class GISControllerTest {
    ...
    void setUp() {
        ...
        controller = new GISController(assetMapper, locationMapper, assetDataPermissionEvaluator);
    }
    ...
    void getAssetsShouldReturnOnlyMappedAssetsForAuthorizedUser() {
        ...
        Result<List<Asset>> result = controller.getAssetsWithLocation(
                null, null, null, null, authorizedAssetUser());
    ...
    void getAssetsShouldResolveSelectedLocationAndItsChildren() {
        ...
        Result<List<Asset>> result = controller.getAssetsWithLocation(
                null, null, null, 5L, authorizedAssetUser());
    ...
    void getStatsShouldGroupMappedAssets() {
        ...
        Result<Map<String, Object>> result = controller.getStats(authorizedAssetUser());
    ...
    void updateLocationShouldPersistCoordinatesWithinCurrentTenant() {
        ...
        when(assetMapper.selectOne(any())).thenReturn(asset(36L, "IDLE", 8L));

        Result<Void> result = controller.updateLocation(36L, request, authorizedAssetUser());
    ...
    private Authentication authorizedAssetUser() {
        return userWith("asset:query", "asset:update");
    }

    private Authentication userWith(String... authorities) {
